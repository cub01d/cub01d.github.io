...
popcorn.footnote({
    ...
    target: "thumbnails",
    text: "<img src='pictures/mccafe.png' class='thumb' onmouseover='display(this.id)' onmouseout='hide()' id='mccafe' />" +
          "<img src='pictures/hotcakes.png' class='thumb' onmouseover='display(this.id)' onmouseout='hide()' id='hotcakes' />" +
          "<img src='pictures/sausage-mcmuffin.png' class='thumb' onmouseover='display(this.id)' onmouseout='hide()' id='sausage-mcmuffin' />",
});    
...
popcorn.footnote({
	...
	text: "<a href='http://ezinearticles.com/?Colorful-Foods,-Potent-Antioxidants&id=481874' target='_blank' onclick='myVideo.pause()'><img src='nutrition/screen.png' /></a>",
	target: "facts"
});
...
popcorn.footnote({
	...
	target: "facts",
	text: "<h5 style='color:black;'>SOURCES:</h5><ul><li><a href='http://www.ehow.com/video_4766268_fruits-can-lower-blood-pressure_.html' target='_blank' onclick='myVideo.pause()'>VIDEO: What Fruits & Vegetables Can Lower Blood Pressure?</a></li><li><a href='http://www.news-medical.net/news/20100217/Eat-fruits-and-vegetables-to-prevent-heart-disease.aspx' target='_blank' onclick='myVideo.pause()'>Eat Fruits and Vegetables to Prevent Heart Disease</a></li></ul>"
});
...
popcorn.footnote({	
	...
	text: "<a href='http://www.choosemyplate.gov/' target='_blank' onclick='myVideo.pause()'><img src='pictures/myplate.jpg' alt='choosemyplate.gov' /></a>",
	target: "facts"
});
...
popcorn.code({start: 55,
    onStart: function() {
      document.getElementById("thumbnails").innerHTML="<img src='pictures/mccafe.png' class='thumb' onmouseover='display_trans(this.id)' onmouseout='hide()' id='mccafe' /><img src='pictures/hotcakes.png' class='thumb' onmouseover='display_trans(this.id)' onmouseout='hide()' id='hotcakes' /><img src='pictures/sausage-mcmuffin.png' class='thumb' onmouseover='display_trans(this.id)' onmouseout='hide()' id='sausage-mcmuffin' />";
    },
});
